...
import { FogFill, useFillGradientStyle, useGlassContainerStyle, useGlassHighlightStyle } from "./GlassBarBase";
...
export const GlassProgressBar = memo(function GlassProgressBar({
  ...
  const baseContainerStyle = useGlassContainerStyle(
    containerWidth as number | string,
