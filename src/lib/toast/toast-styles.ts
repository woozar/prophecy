...
const InfoIcon = createElement("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  width: 20,
  height: 20,
  viewBox: "0 0 24 24",
...
export const successToast = (title: string, message?: string): NotificationData => ({
  ...
  styles: {
    root: {
      ...
      borderRadius: "12px",
      boxShadow: "0 4px 24px rgba(0, 0, 0, 0.5), 0 0 60px rgba(6, 182, 212, 0.25), 0 0 20px rgba(6, 182, 212, 0.2), inset 0 1px 0 rgba(6, 182, 212, 0.15)",
    },
    icon: {
...
export const errorToast = (title: string, message?: string): NotificationData => ({
  ...
  styles: {
    root: {
      ...
      backdropFilter: "blur(16px)",
      borderRadius: "12px",
      boxShadow: "0 4px 24px rgba(0, 0, 0, 0.6), 0 0 60px rgba(239, 68, 68, 0.3), 0 0 30px rgba(239, 68, 68, 0.25), inset 0 1px 0 rgba(239, 68, 68, 0.15)",
    },
    icon: {
...
export const warningToast = (title: string, message?: string): NotificationData => ({
  ...
  styles: {
    root: {
      ...
      backdropFilter: "blur(16px)",
      borderRadius: "12px",
      boxShadow: "0 4px 24px rgba(0, 0, 0, 0.5), 0 0 40px rgba(251, 191, 36, 0.12), inset 0 1px 0 rgba(251, 191, 36, 0.1)",
    },
    icon: {
...
export const infoToast = (title: string, message?: string): NotificationData => ({
  ...
  styles: {
    root: {
      ...
      backdropFilter: "blur(16px)",
      borderRadius: "12px",
      boxShadow: "0 4px 24px rgba(0, 0, 0, 0.5), 0 0 30px rgba(6, 182, 212, 0.1), inset 0 1px 0 rgba(6, 182, 212, 0.08)",
    },
    icon: {
